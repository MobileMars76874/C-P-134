...
if(status != "" && Baby != "Baby not detected"){
r = random(255);
g = random(255);
b = random(255);
...
Baby = "Baby not detected";
document.getElementById("O").innerHTML = "Baby Not Found"
}
else{
console.log(results);
objects = results;
Baby = "Baby detected";
document.getElementById("O").innerHTML = "Baby Found"
}
}